...
out_dir = proj_dir+'data/derivatives/post-fmriprep-fix/'

if computer == 'lucky2' or computer == 'lucky3':
    fmripop_path = '/home/lukeh/hpcworking/lukeH/fmripop-master/'
else:  # assume on hpc
    fmripop_path = '/mnt/lustre/working/lab_lucac/lukeH/fmripop-master/'
...
pipelines = {'detrend': {'niipath': task_nii,
             ...
             'detrend_filtered_gsr_smooth-6mm': {'niipath': rest_nii,
                                                 'maskpath': rest_msk,
                                                 'tsvpath': rest_tsv,
                                                 'add_orig_mean_img': True,
